  ...
  <div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      <div class="flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Qarz kirim</h1>
        <router-link
          to="/storage"
...
import { formatNumber, unformatNumber, parseFormattedNumber } from '../../utils/numberFormat'
...
const handleSubTotalInput = (event, index) => {
  ...
  formData.value.items[index].formatted_sub_total = value
  formData.value.items[index].sub_total = unformatNumber(value)
