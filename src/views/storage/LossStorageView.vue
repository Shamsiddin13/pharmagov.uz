  ...
  <div class="space-y-6">
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      <div class="flex justify-between items-center">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Ombordan chiqarib yuborish</h1>
        <router-link
          to="/storage"
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
      <form @submit.prevent="handleSubmit" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div>
            ...
            <SearchSelect
              ...
              placeholder="Kontragentni tanlash..."
        ...
        <div class="space-y-4 pt-6 border-t border-gray-200 dark:border-gray-700">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Qoshimcha ma'lumot</label>
            <textarea
...
import { lossStorage, API_URL } from '../../services/storageOperations'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const apiData = {
      ...
      k_amount: parseInt(formData.value.k_amount),
    ...
    await lossStorage(apiData)
    router.push('/storage')
  } catch (error) {
    console.error('Failed to save loss storage:', error)
